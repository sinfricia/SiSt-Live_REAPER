local ACTIONS_WITH_SYNC = {
   ["SiSt-Live_Toggle Auto Ansage Levels"] = { deviceKeyword = "wing midi control", msgType = "note_on", midiCh = 5, value1 = 4 }
}
...
for _, val in pairs(ACTIONS_WITH_SYNC) do
   SendMidiMessage(val.deviceKeyword, val.msgType, val.midiCh, val.value1, 127)
end
